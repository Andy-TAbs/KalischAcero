...
function HeroPerfilGalvanizado() {
            ...
            <div className='flex flex-col w-screen min-h-screen h-auto bg-white'>
                <div className='flex lg:flex-row xs:flex-col mt-32 gap-10 justify-center'>
                    <div className='lg:block xs:block md:flex md:flex-col max-w-168 w-auto md:mx-20 xs:mx-20'>
                        <p className='text-neutral-500'>PERFILERÍA</p>
                        <p className='text-neutral-900 text-5xl font-semibold'>Perfil Galvanizado</p>
                        <p className='text-neutral-800 text-justify font-light mt-2 text-md'>El <strong className='font-semibold'>Perfil Tubular Galvanizado</strong> es parte de los perfiles huecos rectangulares son más eficientes que otras secciones de acero en términos de rigidez de torsión y resistencia a la compresión.</p>
                        <p className='text-neutral-800 text-justify font-light mt-2 text-md'>La fuerza de los <i>perfiles tubulares</i> de acero en la relación con el peso es excelente, con articulación metales fácilmente y que transforma las estructuras de buen diseño. El perfil tubular de acero es adecuado para una gran variedad de usos en los marcos de la construcción, armazones, puertas, barandas, soportes, torres, y muchos otros.</p>

                        <h3 className='text-neutral-800 text-justify text-xl font-semibold mt-4'>Dimensiones</h3>
                        <Image src='/productos/Perfil-Galvanizado-2.jpg' alt='productos' width={250} height={250} className="transition-opacity duration-300 hover:opacity-85 w-52 h-auto cursor-pointer mt-4" onClick={() => openModal('/productos/Perfil-Galvanizado-2.jpg')}
                        />
                    ...
                    <div className=' flex flex-col xs:w-screen   lg:w-72 items-center justify-center'>
                        <Image src='/productos/Perfil-Galvanizado-1.jpg' alt='productos' width={300} height={300} className="transition-opacity duration-300 hover:opacity-85 w-72 h-auto"/>
                ...
                <div className='flex xs:w-screen xs:mx-4 lg:w-252 lg:mx-0 h-14 border-t-2 mt-4 mb-4 items-start justify-between'>
                    ...
                    <div className=''>
                            ...
                            <div className='flex flex-col text-neutral-600 justify-end items-end mt-2'>
                                <p className='text-sm'>Perfilería</p>
                                <p className='text-sm font-light '>PTR</p>
                            </div>
                        </a>
                        <a href='/productos/Estructurales/Viga-IPR' className='flex flex-row'>
                            <div className='flex flex-col text-neutral-600 justify-end items-end mt-2'>
                                <p className='text-sm'>Perfilería</p>
                                <p className='text-sm font-light '>Perfil Pintado</p>
                            </div>
                            <div className=''>
                    ...
                    <div className='flex md:flex-row xs:flex-col items-start justify-start md:w-176 lg:w-252 mb-10'>
                        <a className='flex flex-col items-center justify-center' href='/productos/Perfileria/Perfil-Pintado'>
                            <div className='flex flex-col h-66 w-66 transition-all duration-300  justify-center items-center content-center'>
                                    <Image src='/productos/Perfil-Pintado-1.jpg' alt='productos' width={250} height={250} className="transition-opacity duration-300 " />
                            </div>
                            <p className='text-neutral-600 text-sm '>PERFIL PINTADO</p>
                            <p className='text-neutral-600 text-sm '>PERFILERIA</p>
                        </a>

                        <a className='flex flex-col items-center justify-center xs:mt-5 md:mt-0' href='/productos/Perfileria/PTR'>
                            ...
                            <p className='text-neutral-600 text-sm '>PTR</p>
                            <p className='text-neutral-600 text-sm '>PERFILERIA</p>
                        </a>
                    </div>
                </div>
...
export default HeroPerfilGalvanizado;
