                        ...
                        <div className="flex items-center justify-between w-full lg:justify-start lg:flex-grow-0 lg:order-2">
                            ...
                            <div className="hidden lg:flex flex-col lg:flex-row lg:items-center mr-36 lg:ml-auto">
                                <ul className="flex flex-wrap list-none justify-center lg:justify-start">
                                    <li className="mr-3">
                                        <button className="block py-2 pr-4 pl-3 text-sm text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Cotizar</button>
                                    </li>
                                    <li className="mr-3">
